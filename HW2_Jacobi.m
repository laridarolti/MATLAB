% solving of 2D Poisson equation using Jacobi iterative method
% d2FI/dx2+ d2FI/dy2 = 1
...
FInew = FI; % initial value for FInew
    for niter=1:1:10 % number of iterations
     ...
     FI=FInew; % updating all the unknowns simultaneously after one cycle
               % i.e. after going through all grid points
